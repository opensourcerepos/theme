  ...
  _createClass(BlogListItem, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_Card["default"], {
        ...
        className: "bloglistcontent"
      }, _react["default"].createElement(_gatsby.Link, {
        to: blog.frontmatter.path,
        className: "bloglistitema"
      }, _react["default"].createElement(_Typography["default"], {
        gutterBottom: true,
        className: "bloglisttitle"
      }, blog.frontmatter.title)), _react["default"].createElement(_Typography["default"], {
        component: "p",
        className: "blogexcerpt"
      }, blog.excerpt), _react["default"].createElement(_Chip["default"], {
        className: "blogchip",
        label: "".concat(blog.frontmatter.repoOrganization, "/").concat(blog.frontmatter.repoName)
      })));
    }
  }]);
